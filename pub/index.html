  ...
  <!-- Favicons -->
	  ...
	  <link href="../img/apple-touch-icon.png" rel="apple-touch-icon">
		...
		<body>
			...
			<!-- start banner Area -->
			<section class="banner-area relative" id="landing">	
							...
							<div class="single-post d-flex flex-row">
								...
								<div class="details">
									<div class="title d-flex flex-row justify-content-between">
										<div class="titles" style="margin-left: 15px;">
			...
			<footer class="footer-area section-gap">
				<div class="container">
					<div class="row footer-bottom d-flex justify-content-between">
						<p class="col-md-12 col-sm-12 footer-text m-0 text-white">
							<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
Copyright &copy;<script>document.write(new Date().getFullYear());</script> | All rights reserved | e - RGA<a href="https://colorlib.com" target="_blank"></a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						</p>
					</div>
				</div>
