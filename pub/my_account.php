				...
				<div class="card-block">
					<div class="message-box contact-box">
						<div class="row" style="margin: 15px 0px 20px;">          
							...
							<div class="col-xs-6 col-md-4" style="margin-top:10px;"><span class="mf" style="float:left; margin-right:10px;">Theme Color : </span></div>
							<div class="col-xs-6 col-md-8" style="float: right; margin-top:10px;">
